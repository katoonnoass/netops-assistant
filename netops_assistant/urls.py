...
from apps.core.permissions import permission_denied_view
...
urlpatterns = [
    ...
    path("audit/", core_views.audit_list, name="audit_list"),
    path("admin-tools/backup/", core_views.backup_page, name="backup_page"),
    # Configs
    ...
    path(
        "devices/<int:pk>/snapshots/",
        device_views.device_snapshot_list,
        name="device_snapshot_list",
    ),
    path(
        "devices/<int:pk>/snapshots/new/",
        device_views.device_snapshot_upload,
        name="device_snapshot_upload",
    ),
    path(
        "devices/<int:pk>/compare/",
        device_views.device_compare,
        name="device_compare",
    ),
    # Comparisons
